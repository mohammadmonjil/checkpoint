  ...
  (if (or
    ...
    (let* ((input-post
      ...
      (if
       ...
       ;; Replace:
       ;;
       ;;     (append (list input-post input-pre) postfix)
       ;;
       ;; with:
       ;;
       ;;     (append (list input-pre input-post) postfix).
       (append
        (list input-pre input-post)
        postfix)

       ;; INPUT-POST belongs to the prefix. Preserve it and continue
       ;; scanning from the state and metadata reached after executing it.
       (append
        (list input-post)
...
(defthm
  ...
  (implies
   ...
   (cl-state-equivalent-p
    ...
    ;; Execution of the original ordering.
    (run-imp
     st inputs)

    ;; Execution of the completely reordered sequence.
    (run-imp
     st
     (reorder-inputs
      st m inputs))))
