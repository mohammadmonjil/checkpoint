...
(defthm good-msg-list-p-of-channel-state-when-good-state-p
  (implies
   (and
    (good-state-p st)
...
(defthm good-state-p-implies-marker-head-sid-known-somewhere
  ...
  (("Goal"
    :use
    ((:instance good-msg-list-p-of-channel-state-when-good-state-p
                (i i)
                (j j)
                (st st))

     (:instance good-msg-p-of-get-msg-from-channel-when-good-msg-list-p
                (src j)
                (dst i)
                (channels (channels st))
                (ids (proc-ids st))
     ...
     (:instance good-msg-p-marker-implies-some-proc-has-snapshot-id-p
                (msg (get-msg-from-channel j i (channels st)))
                (ids (proc-ids st))
                (procs (procs st))))
    :in-theory
    (disable good-state-p
             good-msg-list-p-of-channel-state-when-good-state-p
...
(defthm good-state-p-implies-recovery-head-sid-known-by-all-procs
  ...
  (("Goal"
    ...
    ((:instance good-msg-list-p-of-channel-state-when-good-state-p
     ...
     (:instance good-msg-p-of-get-msg-from-channel-when-good-msg-list-p-recovery
                (src j)
                (dst i)
                (channels (channels st))
                (ids (proc-ids st))
     ...
     (:instance good-msg-p-recovery-implies-all-procs-have-snapshot-id-p
                (msg (get-msg-from-channel j i (channels st)))
                (ids (proc-ids st))
                (procs (procs st))))
    :in-theory
...
(defthm nbrs-from-to-consistent-for-one-dst-p-when-memberp-src
  (implies
   ...
   (memberp i (nbrs-to (g j procs))))
  :hints
  (("Goal"
    :induct (nbrs-from-to-consistent-for-one-dst-p i srcs procs)
    :in-theory (enable nbrs-from-to-consistent-for-one-dst-p))))
...
(defthm nbrs-from-to-consistent-p-when-memberp-dst
  ...
  :hints
  (("Goal"
    :induct (nbrs-from-to-consistent-p dsts srcs procs)
    :in-theory (enable nbrs-from-to-consistent-p))))


(defthm nbrs-from-implies-nbrs-to
  (implies
   (and
    (good-state-p st)
    (memberp i (proc-ids st))
  ...
  (("Goal"
    :use
    ((:instance nbrs-from-to-consistent-p-when-memberp-dst
                (dsts (proc-ids st))
                (srcs (proc-ids st))
                (procs (procs st))
                (i i))

     (:instance nbrs-from-to-consistent-for-one-dst-p-when-memberp-src
                (i i)
                (j j)
                (srcs (proc-ids st))
                (procs (procs st))))
