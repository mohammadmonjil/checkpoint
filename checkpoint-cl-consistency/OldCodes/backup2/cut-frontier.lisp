...
(defun cut-marker-in-transit-for-dsts-p
  ...
  (if (cm-cut-not-taken-p m src)
    ...
    (if (endp dsts)
      ...
      (let ((dst (first dsts)))
        ...
        (and
         ;; If DST has not taken its cut yet, then the
         ;; target checkpoint marker sent by SRC must
         ;; still be in transit on SRC -> DST.
         (if (cm-cut-not-taken-p m dst)
           ...
           ;; DST has already taken its cut, so there is
           ;; no longer an in-transit obligation.
           t)

         (cut-marker-in-transit-for-dsts-p
          src
          (rest dsts)
          target-sid
          m
...
(defthm cut-marker-in-transit-for-dsts-p-of-before-cut-input-sequence-update
  (equal
   (cut-marker-in-transit-for-dsts-p
    src
    dsts
...
(defthm cut-marker-in-transit-for-dsts-p-of-after-cut-input-sequence-update
  (equal
   (cut-marker-in-transit-for-dsts-p
    src
    dsts
...
(defthm
  cut-marker-in-transit-for-dsts-p-of-inputs-before-cut-update
...
(defthm cut-marker-in-transit-for-dsts-p-preserved-by-send-compute-message
  (implies
   (cut-marker-in-transit-for-dsts-p
    src
    dsts
...
(defthm cut-marker-in-transit-for-dsts-p-preserved-by-send-msg-all-outgoing
  (implies
   (cut-marker-in-transit-for-dsts-p
    src
    dsts
...
(defthm
  cut-marker-in-transit-for-dsts-p-of-inputs-after-cut-update
...
(defthm
  cut-marker-in-transit-for-dsts-p-of-after-cut-msgs-update
...
(defthm
  cut-marker-in-transit-for-dsts-p-preserved-by-remove-normal-message
...
(defthm
  cut-marker-in-transit-for-dsts-p-preserved-by-remove-non-marker-message
...
(defthm
  cut-marker-in-transit-for-dsts-p-of-waiting-marker-from-update
  (equal
   (cut-marker-in-transit-for-dsts-p
    src dsts target-sid
...
(defthm
  cut-marker-in-transit-for-nbrs-p-preserved-when-i-takes-cut
...
;; in PIDS, the destination-level lemma says that P's outgoing
